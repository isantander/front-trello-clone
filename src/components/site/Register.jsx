...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Validar campos
        if (!email.trim()) {
            setError("El campo 'E-mail' es obligatorio.");
            return;
        }
        if (!name.trim()) {
        ...
        setError(""); // Limpiar errores previos si todos los campos están completos
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.error("Error en el registro:", responseJson);
        ...
        <>
            ...
            <Modal isOpen={isModalOpen} onClose={handleCloseModal}>
                ...
                <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                    Se ha enviado un email a su casilla de correo para que finalice el proceso
